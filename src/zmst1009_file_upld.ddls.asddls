    ...
    define view entity zmst1009_file_upld as select from zfile_upload1
    association to parent zprojection_student as _file on $projection.StudentId = _file.studentId 
    {
